...
while not end_program:
    if learning_state:
        ...
        for episode in range(HM_EPISODES):
            ...
            for i in range(3000):
                ...
                dt = env.clock.get_time() / 1000

                obs = int(math.sqrt((following_car.position.x - lead_car.position.x) ** 2 +
                                    (following_car.position.y - lead_car.position.y) ** 2)) - 40
                ...
                new_obs = int(math.sqrt((following_car.position.x - lead_car.position.x) ** 2 +
                                        (following_car.position.y - lead_car.position.y) ** 2)) - 40
                ...
                if show:
                    env.render_cars(lead_car.position.x, lead_car.position.y, following_car.position.x,
                                    following_car.position.y,
    ...
    while not end_program:
        ...
        following_car.action(action, dt)

        following_car.update(dt)
